...
class Card(object):
    ...
    images = []
    template_filename = './card-img/Monster-Card-Template.png'
    dimensions = (6,11)
    ...
    def render(self):
        ...
        while True:
            ...
            if self.attack_annotations:
                ...
                for rollset_ind,(rolls,attack) in enumerate(self.attacks):
                    ...
                    for roll_ind,roll in enumerate(rolls):
                        _add_image(ax,
                                fname = './card-img/Die-{}.png'.format(roll),
                                loc = (
            ...
            ps_file = './monsters/{}.eps'.format(self.name)
            pdf_file = './monsters/{}.pdf'.format(self.name)
