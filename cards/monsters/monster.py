...
class Monster(Card):
    ...
    images = [{'self_fname':'./img/monsters/Monster__{}.png','loc':(0.5,0.75)}]
...
class EliteMonster(Monster):
    template_filename = './img/templates/Elite_Monster_Template.png'

class BossMonster(Monster):
    template_filename = './img/templates/Boss_Monster_Template.png'
